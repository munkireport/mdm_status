<div class="col-md-4">
    <div class="panel panel-default">
        ...
        <div id="ip-panel" class="panel-body text-center">
            <svg id="mdm_status-org-department" style="width:100%; height: 300px"></svg>
        </div>
    </div><!-- /panel -->
</div><!-- /col -->
...
<script>
    $(document).on('appReady', function() {
        ...
        var url = appUrl + '/module/mdm_status/get_org_department'
        var chart;
        d3.json(url, function(err, data){
            ...
            nv.addGraph(function() {
                ...
                d3.select("#mdm_status-org-department")
                    .datum(data)
